...
case 'halah': case 'hilih': case 'huluh': case 'heleh': case 'holoh':
          ...
          reply(`Exif Has Been Successfully Changed to\n\n🦋⃝ Packname : ${global.packname}\n🦋⃝ Author : ${global.author}`)
            }
            break
	case 'kick': {
		if (!m.isGroup) return replay(`${mess.group}`)
...
break
    ...
    *┃⌛Runtime :* ${runtime(process.uptime())}
    ...
    listMessage :{
     title: `Hi ${pushname}`,
     description: `*┏━━━❬ωєⱠ¢Øмє_/\_🆂คɳ𝐝𝖆 𝕭𝖔�❭*
    ...
    *┃📄Description : ${anu.description}
    ...
    break
        case 'ytdoc': {
                    ...
                    const docdown = await GojoMdNx.sendMessage(from , { text: 'ඔයාගෙ සින්දුව 𝐃𝐨𝐰𝐧𝐥𝐨𝐝𝐢𝐧𝐠 ₚₗₑₐₛₑ wₐᵢₜ #♥️⃝̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̇͜͟͟͝➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀─🆂คɳ𝐝𝖆 𝕭𝖔𝖙──❮᭄ͫ➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀❁ཻ͜͡...' }, { quoted: m } )
                    tummb = await getBuffer(anu.thumb)
                    audio = await getBuffer(anu.audio)  
                    await GojoMdNx.sendMessage(from, { delete: docdown.key })
                    const docup = await GojoMdNx.sendMessage(from , { text: 'ඔයාගෙ සින්දුව 𝐔𝐩𝐥𝐨𝐝𝐢𝐧𝐠 ₚₗₑₐₛₑ wₐᵢₜ #♥️⃝̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̇͜͟͟͝➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀─🆂คɳ𝐝𝖆 𝕭𝖔𝖙──❮᭄ͫ➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀❁ཻ͜͡' }, { quoted: m } )      
                ...
                case 'ytmp4': {
                                    ...
                                    const viddown = await GojoMdNx.sendMessage(from , { text: 'ඔයාගෙ විඩියෝව 𝐃𝐨𝐰𝐧𝐥𝐨𝐝𝐢𝐧𝐠 ₚₗₑₐₛₑ wₐᵢₜ #♥️⃝̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̇͜͟͟͝➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀─🆂คɳ𝐝𝖆 𝕭𝖔𝖙──❮᭄ͫ➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀❁ཻ͜͡' }, { quoted: m } )
                                    await GojoMdNx.sendMessage(from, { delete: viddown.key })
                                    const vidup = await GojoMdNx.sendMessage(from , { text: 'ඔයාගෙ විඩියෝව 𝐔𝐩𝐥𝐨𝐝𝐢𝐧𝐠 ₚₗₑₐₛₑ wₐᵢₜ #♥️⃝̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̇͜͟͟͝➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀─🆂คɳ𝐝𝖆 𝕭𝖔𝖙──❮᭄ͫ➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀❁ཻ͜͡' }, { quoted: m } )
                         ...
                         const auddown = await GojoMdNx.sendMessage(from , { text: 'ඔයාගෙ සින්දුව 𝐃𝐨𝐰𝐧𝐥𝐨𝐝𝐢𝐧𝐠 ₚₗₑₐₛₑ wₐᵢₜ #♥️⃝̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̇͜͟͟͝➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀─🆂คɳ𝐝𝖆 𝕭𝖔𝖙──❮᭄ͫ➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀❁ཻ͜͡...' }, { quoted: m } )
                         await GojoMdNx.sendMessage(from, { delete: auddown.key })
                         const audup = await GojoMdNx.sendMessage(from , { text: 'ඔයාගෙ සින්දුව 𝐔𝐩𝐥𝐨𝐝𝐢𝐧𝐠 ₚₗₑₐₛₑ wₐᵢₜ #♥️⃝̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̅̇͜͟͟͝➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀─🆂คɳ𝐝𝖆 𝕭𝖔𝖙──❮᭄ͫ➸⃟̗̗̗̗̗̗̗̗̗̗̗̗̗̗̀̀̀̀̀̀̀̀̀̀̀̀̀❁ཻ͜͡' }, { quoted: m } )
...
latensie = speed() - timestampe
 anu = `*┏━━━❬ωєⱠ¢Øмє _ 🆂คɳ𝐝𝖆 𝕭𝖔𝖙❭*
    
 *Hello 👋..*

     How Are You😼

*┃᳆⃟❁ཻ͜͡𝔻𝕖𝕧𝕖𝕝𝕠𝕡𝕖𝕣* 🎩: *ᜰ꙰ꦿ➢𝐒𝐚𝐧𝐝𝐚𝐫𝐮𝐰𝐧᭄*
